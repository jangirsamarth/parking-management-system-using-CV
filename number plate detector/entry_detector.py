...
while True:
    ...
    if NumberPlateCnt is not None:
        ...
        if text and is_valid_number_plate(text):
            ...
            insert_query = "INSERT INTO in_time (in_time, car_number) VALUES (%s, %s);"
            mycursor.execute(insert_query, (date_time, car_number))
            mydb.commit()
            print(f"Inserted new entry for car number {car_number}")
